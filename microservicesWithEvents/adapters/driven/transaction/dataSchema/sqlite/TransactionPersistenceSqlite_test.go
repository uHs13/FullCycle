package drivenAdapterTransactionDataSchemaSqlite_test
...
var TransactionPersistence *drivenAdapterTransactionDataSchemaSqlite.TransactionPersistenceSqlite
...
func SqliteCreateTable() {
	...
	TransactionPersistence, _ = drivenAdapterTransactionDataSchemaSqlite.NewTransactionPersistenceSqlite(nil)
