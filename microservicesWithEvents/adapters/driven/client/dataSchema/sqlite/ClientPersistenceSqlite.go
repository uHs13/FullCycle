package drivenAdapterClientDataSchemaSqlite
...
func (persistence *ClientPersistenceSqlite) FindById(uuid string) (drivenAdapterClientDataSchema.ClientDto, error) {
...
func (persistence *ClientPersistenceSqlite) Create(client drivenAdapterClientDataSchema.ClientDto) error {
...
func (persistence *ClientPersistenceSqlite) ListAll() ([]drivenAdapterClientDataSchema.ClientDto, error) {
